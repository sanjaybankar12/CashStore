...
var rnc = rnc || {};
sessionStorage.setItem("tempValue", 0);
  ...
  var $displayControl,
    ...
    calculate = function () {
	  ...
	  if(equalsPressed == true){
		//sessionStorage.setItem("budgetcalculatedValue", newVal);
		//location.href = "addNewTransaction.html";
	  }
    },

    setValue = function (val) {
	  sessionStorage.setItem("tempValue", val);
  ...
  $(".key").on('touchstart', function (event) {
    ...
    switch (id) {
      ...
      case "keyPlusMinus":
        ...
        break;
	  case "keyCancel":
		location.href = "addBudgetAmount.html";
		break;
	  case "keyDone":
		if(sessionStorage.getItem("tempValue") > 0)
			sessionStorage.setItem("budgetcalculatedValue",sessionStorage.getItem("tempValue"));
		else
			sessionStorage.setItem("budgetcalculatedValue",0);
		location.href = "addBudgetAmount.html";
		break;
    }
    return false;
