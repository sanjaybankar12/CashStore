  ...
  var $displayControl,
    ...
    calculate = function () {
	  ...
	  if(equalsPressed == true){
		//sessionStorage.setItem("calculatedValue", newVal);
    ...
    switch (id) {
	  ...
	  case "keyDone":
		if(sessionStorage.getItem("tempValue") > 0)
			sessionStorage.setItem("calculatedValue",sessionStorage.getItem("tempValue"));
		else
			sessionStorage.setItem("calculatedValue",0);
		location.href = "index.html";
		break;
    }
    return false;
